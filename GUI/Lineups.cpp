...
Lineups::Lineups(BaseballGame *game)
{
    ...
    connect(game->getAwayTeam(), SIGNAL(pitcherChanged(int)), this, SLOT(awayLineupChanged()));
    ...
    connect(game->getHomeTeam(), SIGNAL(pitcherChanged(int)), this, SLOT(homeLineupChanged()));
    setLayout(myLayout);
    homeLineupChanged();
    awayLineupChanged();
}
